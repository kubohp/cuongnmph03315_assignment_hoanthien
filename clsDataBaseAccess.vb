...
Public Class DataBaseAccess
    ...
    'di thi se ko co cai dong o tren minh se phai khai bao cho no
    Private ConnectionString As String = "Data Source=(local);Initial Catalog=assignment;Integrated Security=True"
